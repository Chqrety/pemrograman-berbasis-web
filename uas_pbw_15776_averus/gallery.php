          ...
          <form method="post" action="" enctype="multipart/form-data">
            <div class="modal-body">
              <div class="mb-3">
                ...
                <textarea class="form-control" placeholder="Tuliskan Deskripsi Gambar" name="deskripsi"
                  required></textarea>
              </div>
              <div class="mb-3">
...
<?php
include "upload_foto.php"; // Pastikan file ini ada

// Jika tombol simpan diklik (Insert & Update)
if (isset($_POST['simpan'])) {
  ...
  if (isset($_POST['id'])) {
    ...
    $stmt->bind_param("sssi", $tanggal, $gambar, $deskripsi, $id);
    $simpan = $stmt->execute();
  } else {
    // Jika tidak ada id, lakukan insert data baru
    $stmt = $conn->prepare("INSERT INTO gallery (tanggal, gambar, deskripsi) VALUES (?, ?, ?)");

    $stmt->bind_param("sss", $tanggal, $gambar, $deskripsi);
    $simpan = $stmt->execute();
  }
