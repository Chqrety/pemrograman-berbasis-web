...
<table class="table table-hover">
    ...
    <tbody>
        ...
        $limit = 5; // Pagination 5 item per halaman
        ...
        ?>
            <tr>
                ...
                <td><?= $row["username"] ?></td>
                <td>
                    <a href="#" title="edit" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $row["id"] ?>">
                        <i class="bi bi-pencil"></i>
                    </a>
                    <a href="#" title="delete" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $row["id"] ?>">
                                ...
                                <form method="post" action="" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" name="password" placeholder="Tuliskan Password Baru (jika ingin mengganti)">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            if ($row["foto"] != '') {
                                                if (file_exists('img/' . $row["foto"] . '')) {
                                            ?>
                                                    <br><img src="img/<?= $row["foto"] ?>" width="100" class="rounded-circle">
                                            <?php
                                                }
                                            }
                                            ?>
