...
Aplikasi web CRUD artikel berbasis PHP & MySQL dengan AJAX (jQuery) dan Bootstrap 5.
...
```
admin.php           # Halaman admin utama (routing dashboard & article)
...
5. Kelola artikel melalui menu admin.

## Catatan

- Pastikan koneksi internet aktif untuk CDN Bootstrap, Icons, dan jQuery.
- Semua fitur CRUD artikel berjalan tanpa reload halaman berkat AJAX.
